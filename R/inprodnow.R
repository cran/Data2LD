inprodnow <- function(fdobj1, fdobj2=NULL, Lfdobj1=int2Lfd(0), Lfdobj2=int2Lfd(0),
        rng = range1, wtfd = 0, 
        EPS = 1e-4, JMAX = 15, JMIN = 5, returnMatrix=FALSE)
{
...
#  Last modified 24 January 2019 by Jim Ramsay
